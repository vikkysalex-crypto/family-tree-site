...
function AddFamilyMember() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        const { error: dbError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("family_members").insert([
            {
                user_id: user.id,
